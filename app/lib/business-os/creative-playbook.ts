...
export function creativePlaybookEvidence(): Evidence {
  return {
    ...
    data:{
      ...
      adaptation:"Preserve Darth Algo branding, prices and existing working integrations. Use real owned chart captures to explain trend, signals and risk, with an obvious next step to /links. Heavy 3D sequences are optional; never slow access to plans or hide the CTA behind an animation.",
