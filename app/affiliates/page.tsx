  ...
  return <div className="min-h-screen bg-[#0d1117] text-white"><SiteHeader /><main>
    <section className="border-b border-white/10 bg-[radial-gradient(circle_at_80%_15%,rgba(220,38,38,.18),transparent_32%)] py-16 sm:py-24">
      <div className="section-shell grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
        <div><span className="inline-flex items-center gap-2 rounded-full border border-ember/30 bg-ember/10 px-4 py-2 text-xs font-black uppercase tracking-[.18em] text-red-200"><BadgeDollarSign className="h-4 w-4" /> Darth Algo Creator Program</span><h1 className="mt-6 max-w-3xl text-4xl font-black leading-tight sm:text-6xl">Teach traders. Grow the community. Earn on every qualified sale.</h1><p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">Approved creators receive indicator access, a personal Stripe promo code, campaign support, and a private dashboard showing tracked customers and commission earnings.</p></div>
        <div className="grid grid-cols-2 gap-3"><div className="rounded-xl border border-white/10 bg-white/[.04] p-6"><p className="text-4xl font-black text-white">25%</p><p className="mt-2 text-sm text-zinc-400">commission on net collected revenue</p></div><div className="rounded-xl border border-white/10 bg-white/[.04] p-6"><p className="text-4xl font-black text-white">Monthly</p><p className="mt-2 text-sm text-zinc-400">payouts after the 30-day hold</p></div><div className="col-span-2 rounded-xl border border-emerald-400/20 bg-emerald-400/[.06] p-6"><p className="flex items-center gap-2 font-black text-emerald-300"><ChartNoAxesCombined className="h-5 w-5" /> Live creator dashboard</p><p className="mt-2 text-sm leading-6 text-zinc-400">See code uses, tracked revenue, pending commission, payable commission, and completed payouts.</p></div></div>
      </div>
    </section>
