...
export default function RetentionPage(){
 ...
 return <main style={{maxWidth:760,margin:'0 auto',padding:'max(24px, env(safe-area-inset-top)) 20px 100px',color:'#f7f7f9'}}>
  <Link href='/owner?view=inbox'>← Command Center</Link><h1>Customer follow-through</h1><p>Private case history and exact drafts. A finding or draft is not a sent message or recovered customer.</p>
