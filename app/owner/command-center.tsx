...
const isPublication = (value: unknown) => isBufferPublication(value) || isInstagramPublication(value);
const publicationNetwork = (value: unknown) => isInstagramPublication(value) ? "Instagram" : "X";
type Agent = {
    id: Department;
    mandate: string;
    state: string;
