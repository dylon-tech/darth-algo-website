...
const sourceNames: Record<string, string> = { stripe_payments_60d: "Payments received · 30-day comparison", growth_30d: "Community visits & clicks", affiliate_ledger: "Partner commissions", affiliate_applications: "Partner applications", stripe_subscriptions: "Stripe subscriptions", tradingview_fulfillment: "Customer access", content_workflows: "Content tools", support_cases: "Customer support", retention: "Customer retention", paid_conversion: "Sales attribution" };
