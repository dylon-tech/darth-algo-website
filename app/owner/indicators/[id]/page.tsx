...
export default async function IndicatorPreview({params}:{params:Promise<{id:string}>}){
  ...
  return <main className="mx-auto max-w-4xl space-y-8 px-6 py-12">
    ...
    <ReviewActions id={id} sourceHash={r.source_hash} stage={r.status}/>
