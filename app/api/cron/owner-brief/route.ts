import { scheduledDailyBrief } from "../../../lib/business-os/brief";
...
export async function GET(request:Request) {
  ...
  try {const brief=await scheduledDailyBrief(); const delivery=await deliverOwnerNotices(); return Response.json({brief,delivery},{headers:{"Cache-Control":"no-store"}});}
