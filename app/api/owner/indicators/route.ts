...
import {ensureIndicatorSchema,recordIndicatorRelease} from "../../../lib/business-os/indicator-lab";
...
export async function POST(r:Request){
  ...
  }catch{return Response.json({error:"RELEASE_NOT_VERIFIED",message:"Requires approval of this exact source, successful TradingView compilation, replay notes, chart screenshot and public script URL."},{status:409,headers:privateHeaders});}
}
