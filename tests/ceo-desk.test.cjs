...
equal(agentView({...base,completed:{...run,status:'completed'}},snapshot,now,true).label,'Live · On standby');
...
equal(serviceView({id:'indicators',observedAt:stamp(1000),details:{status:'prototype_ready',prototypeReady:1,publishing:'release_executor_not_connected'}},now).label,'Prototype ready');
