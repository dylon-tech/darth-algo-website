...
| Premium carousel workflow | Content | implemented and tested; deployment verification pending | Exact reviewed queue assets and ready channels | Four reviewed cinematic posts; two daily slots with exact-hash checks | Verify production preparation and later provider receipts | Observe deployment and next scheduled slot |
